(function () {
    ...
    let tetris = {
        ...
        initBoard: function() {
            ...
            //this.boardDiv = document.getElementId('board'); for debugging
        },
        initInfo: function() {
        ...
        initNextShape: function() {
            ...
            try {
                ...
                throw new Error('could not creat next shape. ' + e);
            }
        },
        ...
        initLevelScores: function () {
            ...
            for (let i = 1; i <= this.numLevels; i++) {
                this ['level' + i] = [c * 1000, 40 * i, 5 * i]; //this is for next level, row score, p sore,
                c = c + c;
            }
        },
        setInfo: function(el) {
        ...
        bindKeyEvents: function () {
            let me = this;
            let event = 'keypress';
            if (this.isSafari() || this.isActive()) {
                event = 'keydown';
            }
            let cb = (e) => {
                me.handleKey(e);
        ...
        handleKey: (e) => {
            ...
            switch (c) {
                ...
                case 40:
                    this.move('D');
                    break;
                case 27: //this is my pause button esc = pause
                    this.togglePause('');
                    break;
                default:
                    break;
        ...
        play: function () {
            ...
            let gameLoop = function () {
                me.move('D');
                if (me.curComplete) {
                    me.markBoardShape(me.curX, me.curShape);
        ...
        checkRows: function () {
            ...
            this.curShape.eachodo(function() {
